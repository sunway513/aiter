...
//
// Host-side utilities in the aiter:: namespace for CK-free builds.
// Provides stream_config, launch_kernel, and other types that non-CK
// modules need without depending on the ck_tile:: namespace.
